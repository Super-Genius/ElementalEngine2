...
"C:\Program Files\Microsoft Visual Studio .NET 2003\Common7\IDE\devenv.com" /build debug "C:\development\ElementalEngine2\ElementalEngine.sln" > BuildLog\EE-Debug-%date:~12,2%_%date:~4,2%_%date:~7,2%-%time:~0,2%_%time:~3,2%_%time:~6,2%.log

echo *** COMPILING EE2-Release ***
"C:\Program Files\Microsoft Visual Studio .NET 2003\Common7\IDE\devenv.com" /build release "C:\development\ElementalEngine2\ElementalEngine.sln" > BuildLog\EE-Release-%date:~12,2%_%date:~4,2%_%date:~7,2%-%time:~0,2%_%time:~3,2%_%time:~6,2%.log
