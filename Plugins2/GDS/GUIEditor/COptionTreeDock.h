...
#ifndef _C_OPTIONTREEDOCK_H_
#define _C_OPTIONTREEDOCK_H_
...
class COptionTreeDock : public CGuiControlBar
{
	DECLARE_DYNAMIC(COptionTreeDock)

public:
	COptionTreeDock(StdString formatFile, StdString formatDir);
	virtual ~COptionTreeDock();
...
#endif // #ifndef _COptionTreeDock_H_
