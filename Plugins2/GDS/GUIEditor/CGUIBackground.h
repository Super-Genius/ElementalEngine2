...
#ifndef CGUIBACKGROUND_H
#define CGUIBACKGROUND_H

class CGUIBackground : public CSceneObject<IGUIElement>
{
private:
	/// Constructor
	/// \param parentName = name of parent in hierarchy
	/// \param name = IHashString * name of this object
	CGUIBackground(IHashString *parentName, IHashString *name);
...
public:
	...
	DWORD OnSetColor(DWORD size, void *param);
