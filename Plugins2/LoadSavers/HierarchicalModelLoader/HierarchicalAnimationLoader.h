#ifndef CHierarchicalAnimationLoader_H
#define CHierarchicalAnimationLoader_H

class CHierarchicalAnimationLoader : public IComponent
{
private:
	SINGLETONCONSTRUCTOROVERRIDE(CHierarchicalAnimationLoader);
	CHierarchicalAnimationLoader();
public:
