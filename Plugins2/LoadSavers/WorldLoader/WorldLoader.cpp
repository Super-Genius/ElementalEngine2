...
DLL_API void InitDLL()
{
	...
	static CHashString CXMLWorldLoaderType(_T("CXMLWorldLoader"));
	toolBox->CreateComponent(&CXMLWorldLoaderType, 0);
}
...
INITDLLINFO WORLDLOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	WORLDLOADER_LIBEXTERNS
};
