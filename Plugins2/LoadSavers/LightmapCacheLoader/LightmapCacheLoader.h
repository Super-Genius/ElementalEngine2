...
class LightmapCacheLoader : public IComponent
{
private:
	SINGLETONCONSTRUCTOROVERRIDE(LightmapCacheLoader);
	LightmapCacheLoader();
public:
	...
	DWORD OnLoadLMPFile(DWORD size, void *params);

	/// message to save a Particle Emitter file
	DWORD OnSaveLMPFile(DWORD size, void *params);
