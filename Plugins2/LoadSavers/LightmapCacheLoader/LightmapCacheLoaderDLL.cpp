...
DLL_API void InitDLL()
{
	...
	static CHashString LightmapCacheLoaderType(_T("LightmapCacheLoader"));
	toolBox->CreateComponent(&LightmapCacheLoaderType, 0);
}
...
INITDLLINFO LIGHTMAPCACHELOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	LIGHTMAPCACHELOADER_LIBEXTERNS
};
