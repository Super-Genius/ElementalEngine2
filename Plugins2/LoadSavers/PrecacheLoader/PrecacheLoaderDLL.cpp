...
DLL_API void InitDLL()
{
	...
	CHashString CPrecacheLoaderType(_T("CPrecacheLoader"));
	toolBox->CreateComponent(&CPrecacheLoaderType, 0);
}
...
INITDLLINFO PRECACHELOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	PRECACHELOADER_LIBEXTERNS
};
