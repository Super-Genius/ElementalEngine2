...
DLL_API void InitDLL()
{
	...
	CHashString CDX9ShaderLoaderType(_T("CDX9ShaderLoader"));
	toolBox->CreateComponent(&CDX9ShaderLoaderType, 0);
}
...
INITDLLINFO HLSLSHADERLOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	HLSLSHADERLOADER_LIBEXTERNS
};
