...
DLL_API void InitDLL()
{
	...
	static CHashString CSplineLoaderType(_T("CSplineLoader"));
	toolBox->CreateComponent(&CSplineLoaderType, 0);
}
...
INITDLLINFO SPLINELOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	SPLINELOADER_LIBEXTERNS
};
