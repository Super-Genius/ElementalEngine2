...
#ifndef OBJECTCUBEMAPLOADER_H
#define OBJECTCUBEMAPLOADER_H

class ObjectCubeMapLoader : public IComponent
{
private:
	SINGLETONCONSTRUCTOROVERRIDE(ObjectCubeMapLoader);
	ObjectCubeMapLoader();
public:
...
private:
	...
	/// map of bools to see if a file has already been loaded
	map<DWORD, bool> m_mFileLoaded;
};
