...
DLL_API void InitDLL()
{
	...
	static CHashString ObjectCubeMapLoaderType(_T("ObjectCubeMapLoader"));
	toolBox->CreateComponent(&ObjectCubeMapLoaderType, 0);
}
...
INITDLLINFO OBJECTCUBEMAPLOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	OBJECTCUBEMAPLOADER_LIBEXTERNS
};
