...
{
	SINGLETONINSTANCE(CDatabaseIO);
	SINGLETONINSTANCE(CSchemaLoader);
	SINGLETONINSTANCE(CDefinedDatabaseLoader);
}
...
INITDLLINFO DATABASEIO_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	DATABASEIO_LIBEXTERNS
};
