...
#define PROJECTLOADSAVE_PRIORITY 2069
...
DLL_API void InitDLL()
{
	...
	toolBox->CreateComponent(&CHashString("CProjectLoadSave"), 0);
}
...
{
	return PROJECTLOADSAVE_PRIORITY;
}
...
INITDLLINFO PROJECTLOADSAVE_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	PROJECTLOADSAVE_LIBEXTERNS
};
