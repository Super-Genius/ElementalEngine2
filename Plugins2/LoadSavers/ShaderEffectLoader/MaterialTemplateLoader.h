...
#ifndef MATTEMPLATELOADER_H
#define MATTEMPLATELOADER_H

class CMaterialTemplateLoader : public IComponent
{
private:
	SINGLETONCONSTRUCTOROVERRIDE(CMaterialTemplateLoader);
	CMaterialTemplateLoader();
public:
