...
DLL_API void InitDLL()
{
	...
	static CHashString CPhysicsLoaderType(_T("CPhysicsLoader"));
	toolBox->CreateComponent(&CPhysicsLoaderType, 0);
}
...
INITDLLINFO PHYSICSLOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	PHYSICSLOADER_LIBEXTERNS
};
