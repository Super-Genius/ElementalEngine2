...
DLL_API void InitDLL()
{
	...
	CHashString CLuaScriptLoaderType(_T("CLuaScriptLoader"));
	toolBox->CreateComponent(&CLuaScriptLoaderType, 0);
}
...
INITDLLINFO LUALOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	LUALOADER_LIBEXTERNS
};
