...
DLL_API void InitDLL()
{
	...
	static CHashString CXMLSpawnLoaderType(_T("CXMLSpawnLoader"));
	toolBox->CreateComponent(&CXMLSpawnLoaderType, 0);
}
...
INITDLLINFO SPAWNLOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	SPAWNLOADER_LIBEXTERNS
};
