...
DLL_API void InitDLL()
{
	...
	static CHashString CStateLoaderType(_T("CStateLoader"));
	toolBox->CreateComponent(&CStateLoaderType, 0);
}
...
INITDLLINFO STATELOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	STATELOADER_LIBEXTERNS
};
