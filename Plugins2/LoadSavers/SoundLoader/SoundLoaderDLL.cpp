...
DLL_API void InitDLL()
{
	...
	static CHashString CSoundLoaderType(_T("CSoundLoader"));
	toolBox->CreateComponent(&CSoundLoaderType, 0);
}
...
INITDLLINFO SOUNDLOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	SOUNDLOADER_LIBEXTERNS
};
