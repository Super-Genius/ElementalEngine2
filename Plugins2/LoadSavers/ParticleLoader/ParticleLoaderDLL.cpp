...
DLL_API void InitDLL()
{
	...
	static CHashString CParticleLoaderType(_T("CParticleLoader"));
	static CHashString CParticleEmitterLoaderType(_T("CParticleEmitterLoader"));
	toolBox->CreateComponent(&CParticleLoaderType, 0);
	toolBox->CreateComponent(&CParticleEmitterLoaderType, 0);
}
...
INITDLLINFO PARTICLELOADER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	PARTICLELOADER_LIBEXTERNS
};
