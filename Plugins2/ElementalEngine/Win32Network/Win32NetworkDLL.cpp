///============================================================================
/// \file		Win32NetworkDLL.cpp
/// \brief		Implementation of Win32 Network System (using Raknet)
/// \date		06-27-2008
...
#define WIN32NETWORKPRIORITY_PRIORITY 3300
...
DLL_API void InitDLL()
{
	...
	static CHashString hszNetworkMgr(_T("CWin32NetworkManager"));
	toolBox->CreateComponent(&hszNetworkMgr, 0);
}
...
{
	return WIN32NETWORKPRIORITY_PRIORITY;
}

#ifdef _LIB
INITDLLINFO WIN32NETWORK_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL
