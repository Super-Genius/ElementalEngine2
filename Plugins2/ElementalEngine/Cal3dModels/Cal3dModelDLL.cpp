...
#define CAL3DMODEL_PRIORITY 18500
...
DLL_API void InitDLL()
{
	...
	static CHashString Cal3dName("Cal3DModelManager");

	toolBox->CreateComponent(&Cal3dName, 0);

}

DLL_API void DeInitDLL()
{
	SINGLETONINSTANCE(Cal3DModelManager)->DeInit();
}
...
{
	return CAL3DMODEL_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO CAL3DMODEL_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	CAL3DMODEL_LIBEXTERNS
};
#endif
