// CoordinateToolDLL.cpp : Defines the entry point for the DLL application.
//

///============================================================================
/// \file	CoordinateToolDLL.cpp
...
#define DETAILOBJECT_PRIORITY 22500
...
{
	return DETAILOBJECT_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO DETAILOBJECT_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	DETAILOBJECT_LIBEXTERNS
};
#endif
