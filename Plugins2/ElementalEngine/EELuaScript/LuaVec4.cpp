...
IVec4Implementation *CLuaVec4::m_Vec4Impl;

void CLuaVec4::InitImplementation()
{
	ACTIVEMATHIMPLEMENTATION msg;
	msg.dwImplementationName = CHashString( _T("Vec4DefaultImplementation") ).GetUniqueID();
	...
	{
		m_Vec4Impl = (IVec4Implementation *)msg.pImplementation;
	}
