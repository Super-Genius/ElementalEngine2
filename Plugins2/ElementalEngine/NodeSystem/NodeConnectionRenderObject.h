///============================================================================
/// \file		NodeConnectionRenderObject.h
/// \brief		Declaration of CNodeConnectionRenderObject Class
/// \date		07-18-2007
...
#ifndef __NODECONNECTIONRENDEROBJECT_H__
#define __NODECONNECTIONRENDEROBJECT_H__

class CNodeConnection;

class CNodeConnectionRenderObject : public CSceneObject<IRenderObject>
{
private:
	/// Default Constructor
	CNodeConnectionRenderObject(IHashString *parentName, IHashString *name);

public:
	/// Default Destructor
	~CNodeConnectionRenderObject();
...
private:
	...
	CNodeConnection *m_NodeConnection;
	CNodeSystem *m_NodeSystem;

	CHashString m_hszComponentType;
};

#endif //__NODECONNECTIONRENDEROBJECT_H__