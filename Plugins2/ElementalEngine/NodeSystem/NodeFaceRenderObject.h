///============================================================================
/// \file		NodeFaceRenderObject.h
/// \brief		Declaration of CNodeFaceRenderObject Class
/// \date		07-30-2007
...
#ifndef __NODEFACERENDEROBJECT_H__
#define __NODEFACERENDEROBJECT_H__

class CNodeFace;

class CNodeFaceRenderObject : public CSceneObject<IRenderObject>
{
private:
	/// Default Constructor
	CNodeFaceRenderObject(IHashString *parentName, IHashString *name);

public:
	/// Default Destructor
	~CNodeFaceRenderObject();
