///============================================================================
/// \file		NodeRenderObject.h
/// \brief		Declaration of CNodeRenderObject Class
/// \date		07-18-2007
...
#ifndef __NODERENDEROBJECT_H__
#define __NODERENDEROBJECT_H__

class CNode;
class CNodeSystem;

class CNodeRenderObject : public CSceneObject<IRenderObject>
{
private:
	/// Default Constructor
	CNodeRenderObject(IHashString *parentName, IHashString *name);
...
private:
	...
	/// Node object corresponding to this node object
	CNode *m_Node;
