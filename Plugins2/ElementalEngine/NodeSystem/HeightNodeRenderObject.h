///============================================================================
/// \file		HeightNodeRenderObject.h
/// \brief		Declaration of CHeightNodeRenderObject Class
/// \date		08-08-2007
...
#ifndef __HEIGHTNODERENDEROBJECT_H__
#define __HEIGHTNODERENDEROBJECT_H__

class CHeightNode;

class CHeightNodeRenderObject : public CSceneObject<IRenderObject>
{
private:
	/// Default Constructor
	CHeightNodeRenderObject(IHashString *parentName, IHashString *name);

public:
	/// Default Destructor
	~CHeightNodeRenderObject();
...
private:
	...
	CHeightNode *m_HeightNode;
	CNodeSystem *m_NodeSystem;

	CHashString m_hszComponentType;
};

#endif //__HEIGHTNODERENDEROBJECT_H__