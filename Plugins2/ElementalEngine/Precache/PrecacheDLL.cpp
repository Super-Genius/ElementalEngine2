///==========================================================================
/// \file	PrecacheDLL.cpp
/// \brief	Implementation of Precache DLO
/// \date	12/06/2007
...
#define PRECACHE_PRIORITY 15500
...
DLL_API void InitDLL()
{
	...
	static CHashString CPMName("CPrecacheManager");
	toolBox->CreateComponent(&CPMName, 0);
...
{
	return PRECACHE_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO PRECACHE_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
