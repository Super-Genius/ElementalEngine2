...
#define QHSTATEMACHINE_PRIORITY 22100
...
DLL_API void InitDLL()
{
	...
	SINGLETONINSTANCE(CQHStateMachineManager);
}
...
{
	return QHSTATEMACHINE_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO QHSTATEMACHINE_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	QHSTATEMACHINE_LIBEXTERNS
};
#endif
