...
#define LIGHTMAPOBJECT_PRIORITY 17000
...
DLL_API void InitDLL()
{
	...
	toolBox->CreateComponent(&CHashString("LightMapManager"), 0);
...
{
	return LIGHTMAPOBJECT_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO LIGHTMAPOBJECT_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	LIGHTMAPOBJECT_LIBEXTERNS
};
#endif
