...
DLL_API void InitDLL()
{
	...
	static CHashString CLSHName("CLuaStateHandler");

	toolBox->CreateComponent(&CLSHName, 0);
}
...
{
	return LUANSM_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO LUANSM_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
