///============================================================================
/// \file		LODFadeShaderCallback.cpp
/// \brief		Implementation for CLODFadeShaderCallback class
/// \date		10-31-2005
...
CLODFadeShaderCallback::CLODFadeShaderCallback()
{
	// grab the tool box
	...
	m_ShaderCallbackName = new CHashString(_T("ModelAlphaFadeUpdate"));
...
void CLODFadeShaderCallback::ShaderCallback(IShader *shader, float time)
{
	TIMEOFDAYDESC tod;
	Vec3 sunDir;
	...
	//	%%%%todo, fix, not sure we have clip distances for shaders?
	//shader->SetClipDistance(200.0f);
}

IHashString* CLODFadeShaderCallback::GetCallbackName()
{
