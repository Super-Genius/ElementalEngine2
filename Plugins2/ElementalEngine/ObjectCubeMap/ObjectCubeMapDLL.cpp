...
#define OBJECTCUBEMAP_PRIORITY 28000
...
DLL_API void InitDLL()
{
	...
	//SINGLETONINSTANCE(CObjectCubeMapManager);
	//manager->Init();
}
...
{
	return OBJECTCUBEMAP_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO OBJECTCUBEMAP_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	OBJECTCUBEMAP_LIBEXTERNS
};
#endif
