///============================================================================
/// \file		Win32JoystickDLL.cpp
/// \brief		Implementation of Win32Joystick System
/// \date		04-03-2008
...
#define WIN32JOYSTICKPRIORITY_PRIORITY 3000
...
{
	// make sure these initialize themselves.
	SINGLETONINSTANCE(CWin32JoystickHandler);
	SINGLETONINSTANCE(CInput);
}
...
{
	return WIN32JOYSTICKPRIORITY_PRIORITY;
}

#ifdef _LIB
INITDLLINFO WIN32JOYSTICK_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL
