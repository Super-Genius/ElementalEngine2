...
******************************************************************************/
#ifndef MESH_MENDER_H
#define MESH_MENDER_H
...
// non-sense for checking if Vec3 < Vec3.  What does that really
// mean?  They are using Vec3 as a key in a map and really just want
// to know if they are even or not.
class MeshMender
{
	...
	protected:
        ...
        // for each triangle in the group, should it be flipped?
        typedef std::vector< std::vector< int > >      FlipGroupList;
