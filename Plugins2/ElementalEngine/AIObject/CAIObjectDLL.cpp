...
#define AIOBJECT_PRIORITY 21500
...
DLL_API void InitDLL()
{
	...
	SINGLETONINSTANCE(CAIManager);
}

/// GDS specific: run-time version testing of DLLs.
...
{
	return AIOBJECT_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO AIOBJECT_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
