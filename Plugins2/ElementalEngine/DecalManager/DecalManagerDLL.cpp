...
#define DECALDLL_PRIORITY 32000
...
DLL_API void InitDLL()
{
	...
	static CHashString CDMName(_T("CDecalManager"));
	toolBox->CreateComponent(&CDMName, 0);
...
{
	return DECALDLL_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO DECALMANAGER_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
	DECALMANAGER_LIBEXTERNS
};
#endif
