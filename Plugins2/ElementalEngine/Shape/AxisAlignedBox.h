...
/// \brief		Declaration of CAxisAlignedBoxRenderObject Object Class
/// \date		07-25-2005
...
class CAxisAlignedBoxRenderObject : public CSceneObject<IRenderObject	>
{
private:
	/// Default Constructor
	CAxisAlignedBoxRenderObject( IHashString *parentName, IHashString *name );
	/// Default Destructor
	~CAxisAlignedBoxRenderObject();
...
public:
	...
	/// Initializes the CAxisAlignedBoxRenderObject
	virtual void Init();
