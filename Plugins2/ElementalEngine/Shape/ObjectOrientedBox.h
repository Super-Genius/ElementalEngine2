///============================================================================
/// \file		BoundingBox.h
/// \brief		Declaration of CObjectOrientedBoxRenderObject Object Class
/// \date		07-25-2005
...
///============================================================================
#ifndef __OBJECTORIENTEDBOX_H__
#define __OBJECTORIENTEDBOX_H__

class CObjectOrientedBoxRenderObject : public CSceneObject <IRenderObject >
{
private:
	/// Default Constructor
	CObjectOrientedBoxRenderObject(IHashString *parentName, IHashString *name);
	/// Default Destructor
	~CObjectOrientedBoxRenderObject();
...
public:
	...
	/// Initializes the CObjectOrientedBoxRenderObject
	virtual void Init();
