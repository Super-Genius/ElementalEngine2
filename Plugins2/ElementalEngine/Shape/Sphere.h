///============================================================================
/// \file		Sphere.h
/// \brief		Declaration of CSphereRenderObject Object Class
/// \date		07-25-2005
...
class CSphereRenderObject : public CSceneObject<IRenderObject	>
{
private:
	/// Default Constructor
	CSphereRenderObject(IHashString *parentName, IHashString *name);
	/// Default Destructor
	~CSphereRenderObject();
...
public:
	...
	/// Initializes the CSphereRenderObject
	virtual void Init();
