///============================================================================
/// \file		Line.h
/// \brief		Declaration of CLineRenderObject Object Class
/// \date		07-25-2005
...
class CLineRenderObject : public CSceneObject<IRenderObject	>
{
private:
	/// Default Constructor
	CLineRenderObject( IHashString *parentName, IHashString *name );
	/// Default Destructor
	~CLineRenderObject();
...
public:
	...
	/// Initializes the CLineRenderObject
	virtual void Init();
