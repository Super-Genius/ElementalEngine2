///============================================================================
/// \file		ClothRenderObject.h
/// \brief		Header file for a Cloth Render Object
/// \date		06-25-2007
...
#ifndef	CLOTHRENDEROBJECT_H
#define	CLOTHRENDEROBJECT_H

#include "CObjectTemplate.hpp"
#include "CRenderObject.h"

class CClothRenderObject : public CRenderObject<>
{
protected:
	/// \brief Default Constructor
	/// \param parentName = name of parent in hierarchy
	/// \param name = IHashString * name of this object
	CClothRenderObject(IHashString *parentName, IHashString *name, bool bAddToHier);

public:
	/// \briefDefault Destructor
	virtual ~CClothRenderObject();
	...
	bool AllocateVertices( int iVertexCount, CHANNELDESCRIPTORLIST VertexFormat, int stride );
...
private:
	...
	StdString m_szParentRenderObjectName;
	StdString m_szNodeName;
