...
{
	static CHashString CMName("CClothManager");
	EngineGetToolBox()->CreateComponent(&CMName, 0);
}
...
{
	return CLOTH_PRIORITY;
}

#ifdef _LIB
#include ".\StaticLibSymbols.h"
INITDLLINFO CLOTH_INITDLLINFO = {
	InitDLL, 
	GetDLLVersion, 
	GetPriority, 
	NULL,
