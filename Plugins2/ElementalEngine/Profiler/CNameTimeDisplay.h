...
#ifndef _C_NAMETIMEDISPLAY_H_
#define _C_NAMETIMEDISPLAY_H_

class CNameTimeDisplay : public IProfileDisplayType
{
public:
	/// ctor / dtor
	CNameTimeDisplay();
	virtual ~CNameTimeDisplay();
