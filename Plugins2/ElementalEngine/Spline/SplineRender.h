///============================================================================
/// \file		SplineRender.h
/// \brief		Declaration of CSplineRenderObject Class
/// \date		09-10-2005
...
#ifndef __SPLINERENDEROBJECT_H__
#define __SPLINERENDEROBJECT_H__

#include "CObjectTemplate.hpp"
#include "Vec3.h"
#include "IRenderObject.h"

class CSplineRenderObject : public CSceneObject<IRenderObject>
{
private:
	/// Default Constructor
	CSplineRenderObject(IHashString *parentName, IHashString *name);
...
public:
	...
	void SetToRender(bool value) { m_bRender = value; }
...
#endif //__SPLINERENDEROBJECT_H__
