///============================================================================
/// \file		ObjectGridToolRenderObject.h
/// \brief		Declaration of ObjectGridToolRenderObject Object Class
...
///============================================================================
#ifndef __OBJECTGRIDTOOLRENDEROBJECT_H__
#define __OBJECTGRIDTOOLRENDEROBJECT_H__

#include "CObjectTemplate.hpp"

class CObjectGridToolRenderObject : public CSceneObject<IRenderObject>
{
private:
	/// Default Constructor
	CObjectGridToolRenderObject(IHashString *parentName, IHashString *name);
	/// Default Destructor
	~CObjectGridToolRenderObject();
...
public:
	...
	/// Initializes the CObjectGridToolRenderObject
	virtual void Init();
...
#endif //__OBJECTGRIDTOOLRENDEROBJECT_H__
