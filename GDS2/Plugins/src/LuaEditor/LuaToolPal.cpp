...
BEGIN_MESSAGE_MAP(CLuaToolPal, CGuiToolBarWnd)
	//{{AFX_MSG_MAP(CLuaToolPal)
...
/////////////////////////////////////////////////////////////////////////////
// CLuaToolPal message handlers


void CLuaToolPal::On3dButton() 
{
	MessageBox(_T("3d Button Pressed"), _T("Button Pressed"));	
}


void CLuaToolPal::OnUpdate3dButton(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable();	
}


void CLuaToolPal::OnTestPalButton2() 
{
	MessageBox(_T("Test Palette Button 2 Pressed"), _T("Button Pressed"));		
}


void CLuaToolPal::OnUpdateTestPalButton2(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable();
}


void CLuaToolPal::OnTestPalButton3() 
{
	MessageBox(_T("Test Palette Button 3 Pressed"), _T("Button Pressed"));
}


void CLuaToolPal::OnUpdateTestPalButton3(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable();	
}


int CLuaToolPal::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
