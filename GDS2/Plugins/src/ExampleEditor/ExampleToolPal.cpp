...
CExampleToolPal::CExampleToolPal()
{
}
...
BEGIN_MESSAGE_MAP(CExampleToolPal, CGuiToolBarWnd)
	//{{AFX_MSG_MAP(CExampleToolPal)
...
/////////////////////////////////////////////////////////////////////////////
// CExampleToolPal message handlers


void CExampleToolPal::On3dButton() 
{
	MessageBox(_T("3d Button Pressed"), _T("Button Pressed"));	
}


void CExampleToolPal::OnUpdate3dButton(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable();	
}


void CExampleToolPal::OnTestPalButton2() 
{
	MessageBox(_T("Test Palette Button 2 Pressed"), _T("Button Pressed"));		
}


void CExampleToolPal::OnUpdateTestPalButton2(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable();
}


void CExampleToolPal::OnTestPalButton3() 
{
	MessageBox(_T("Test Palette Button 3 Pressed"), _T("Button Pressed"));
}


void CExampleToolPal::OnUpdateTestPalButton3(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable();	
}


int CExampleToolPal::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
