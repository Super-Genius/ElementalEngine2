...
class CExampleFrm : public CMDIChildWnd
{
	DECLARE_DYNCREATE(CExampleFrm)
protected:
	
	CExampleFrm();           // protected constructor used by dynamic creation

// Attributes
public:
	
	CExampleToolPal m_ExampleToolPal;
