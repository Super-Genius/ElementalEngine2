...
"C:\Program Files\Microsoft Visual Studio .NET 2003\Common7\IDE\devenv.com" /rebuild debug "C:\development\GDS2\GDSBase.sln" > BuildLog\GDS2-Debug-%date:~12,2%_%date:~4,2%_%date:~7,2%-%time:~0,2%_%time:~3,2%_%time:~6,2%.log

echo *** COMPILING GDS2-Release ***
"C:\Program Files\Microsoft Visual Studio .NET 2003\Common7\IDE\devenv.com" /rebuild release "C:\development\GDS2\GDSBase.sln" > BuildLog\GDS2-Release-%date:~12,2%_%date:~4,2%_%date:~7,2%-%time:~0,2%_%time:~3,2%_%time:~6,2%.log
